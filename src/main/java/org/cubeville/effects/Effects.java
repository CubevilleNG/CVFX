...
public class Effects extends JavaPlugin {
    ...
    private void initializeCommands() {
        ...
        commandParser.addCommand(new AbortRunningEffectCommand());
        //commandParser.addCommand(new BigCleanup());
        ...
        commandParser.addCommand(new EffectModifyNPCCommand());
        ...
        commandParser.addCommand(new HookRemoveMove());
        ...
        commandParser.addCommand(new InteractHookPlayerCommand());
        commandParser.addCommand(new InteractHookPlayerForPlayerCommand());
        commandParser.addCommand(new ListRunningEffectsCommand());
