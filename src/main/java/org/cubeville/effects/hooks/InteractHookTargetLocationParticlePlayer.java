...
public class InteractHookTargetLocationParticlePlayer implements InteractHook
{
	...
	Player player = event.getPlayer();
        ...
        new ParticleEffectTimedRunnable(Effects.getInstance(), player, effect, stepsPerTick, speed, loc, false, false, false, false, false, 0, false).runTaskTimer(Effects.getInstance(), 1, 1);
